...
public func collectMessagesActivity(
    ...
    guard checkPreferencesStateUseCase(with: id, personality: .messagesActivity(.empty)) else { return }
    guard checkCollectStateUseCase(with: id, personality: .messagesActivity(.empty)) else { return }
