...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "git@bitbucket.org:mobyrix/nicegram-assistant-ios.git", branch: "qa/build-526"),
        .package(url: "git@bitbucket.org:mobyrix/nicegram-wallet-ios.git", branch: "qa/build-526")
    ]
)
