...
public struct PresentationResourcesSettings {
    public static let nicegramIcon = renderIcon(name: "Settings/MenuIcons/NiceSettings")
    public static let premiumIcon = renderIcon(name: "Settings/MenuIcons/PremiumSettings")
