...
public struct ExperimentalUISettings: Equatable, PreferencesEntry {
    ...
    public static var defaultSettings: ExperimentalUISettings {
        return ExperimentalUISettings(keepChatNavigationStack: false, skipReadHistory: false, crashOnLongQueries: false, chatListPhotos: false, brr: false, knockoutWallpaper: false, gradientBubbles: false)
    }
    
    public init(keepChatNavigationStack: Bool, skipReadHistory: Bool, crashOnLongQueries: Bool, chatListPhotos: Bool, brr: Bool, knockoutWallpaper: Bool, gradientBubbles: Bool) {
