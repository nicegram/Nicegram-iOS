//
//  NiceSettingsFiltersAmountItem.swift
//  TelegramUI
//
//  Created by Sergey on 12/07/2019.
...
final class NiceSettingsFiltersAmountActionSheetController: ActionSheetController {
    ...
    init(context: AccountContext, currentValue: Int32, applyValue: @escaping (Int32) -> Void) {
        ...
        var updatedValue = currentValue > 0 ? currentValue : 1
        self.setItemGroups([
            ActionSheetItemGroup(items: [
                NiceSettingsFiltersAmountSelectorItem(strings: strings, currentValue: updatedValue, valueChanged: { value in
                    updatedValue = value
                }),
...
private final class NiceSettingsFiltersAmountSelectorItem: ActionSheetItem {
    ...
    func node(theme: ActionSheetControllerTheme) -> ActionSheetItemNode {
        return NiceSettingsFiltersAmountSelectorItemNode(theme: theme, strings: self.strings, currentValue: self.currentValue, valueChanged: self.valueChanged)
    }
...
private final class NiceSettingsFiltersAmountSelectorItemNode: ActionSheetItemNode, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func pickerView(_ pickerView: UIPickerView, attributedTitleForRow row: Int, forComponent component: Int) -> NSAttributedString? {
        return NSAttributedString(string: String(timeoutValues[row]), font: Font.medium(15.0), textColor: self.theme.primaryTextColor)
    }
