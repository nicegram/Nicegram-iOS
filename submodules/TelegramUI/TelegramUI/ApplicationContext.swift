...
final class AuthorizedApplicationContext {
    ...
    init(sharedApplicationContext: SharedApplicationContext, mainWindow: Window1, watchManagerArguments: Signal<WatchManagerArguments?, NoError>, context: AccountContextImpl, accountManager: AccountManager, foo: Bool, showCallsTab: Bool, showFilteredChatTabs: [NiceChatListNodePeersFilter]?, showContactsTab: Bool, maxFilters: Int32, reinitializedNotificationSettings: @escaping () -> Void) {
