...
final class ChatMessageSelectionInputPanelNode: ChatInputPanelNode {
    ...
    init(theme: PresentationTheme, strings: PresentationStrings) {
        ...
        self.cloudButton.setImage(generateTintedImage(image: UIImage(bundleImageName: "Chat/Message/FileCloudFetch"), color: theme.chat.inputPanel.panelControlAccentColor), for: [.normal])
        self.cloudButton.setImage(generateTintedImage(image: UIImage(bundleImageName: "Chat/Message/FileCloudFetch"), color: theme.chat.inputPanel.panelControlDisabledColor), for: [.disabled])
