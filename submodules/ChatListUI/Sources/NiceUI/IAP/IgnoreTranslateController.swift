...
private func ignoreTranslateControllerEntries(presentationData: PresentationData, premiumSettings: PremiumSettings) -> [Entry] {
    var entries: [Entry] = []
    let theme = presentationData.theme
    let strings = presentationData.strings
    let locale = presentationData.strings.baseLanguageCode
    
    let ignoredTranslations = premiumSettings.ignoreTranslate
